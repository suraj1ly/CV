...
net = torchvision.models.alexnet(True)
#net= torchvision.models.vgg16(True)
#net=torchvision.models.densenet161(True)
#net=torchvision.models.inception_v3(True)
net.to(device)
...
data1,lbl=train(trainloader,net)
...
Xtr1=pca.transform(Xtr1)
Xte1=pca.transform(Xte1)
